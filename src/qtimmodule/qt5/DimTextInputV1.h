...
protected:
    ...
    void zwp_dim_text_input_v1_preedit_string(const char *text, int32_t cursor_begin, int32_t cursor_end) override;
    void zwp_dim_text_input_v1_commit_string(const char *text) override;
    void zwp_dim_text_input_v1_delete_surrounding_text(uint32_t before_length, uint32_t after_length) override;
    void zwp_dim_text_input_v1_done(uint32_t serial) override;
    void zwp_dim_text_input_v1_keysym(uint32_t serial, uint32_t time, uint32_t sym, uint32_t state, uint32_t modifiers) override;
