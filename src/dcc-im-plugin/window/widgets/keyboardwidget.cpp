...
void KeyboardWidget::setKeyboardLayout(const QString &layout, const QString &variant)
{
...
void KeyboardWidget::showNoLayout()
{
    m_status = LayoutStatus::NoLayout;
    m_layout = "";
    m_variant = "";
...
void KeyboardWidget::paintLayout(QPainter &painter)
{
