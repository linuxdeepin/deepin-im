...
public:
    ...
    explicit Flags(storage_type i = 0)
        : flags_(i)
    {
    }
    ...
    constexpr inline Flags operator|(Flags f) const { return Flags(flags_ | f.flags_); }
    ...
    constexpr inline Flags unset(Flags f) const { return Flags(flags_ & (~f.flags_)); }
    ...
    constexpr bool operator==(const Flags &f) const { return flags_ == f.flags_; }

    constexpr bool operator==(Enum f) const { return flags_ == static_cast<storage_type>(f); }
