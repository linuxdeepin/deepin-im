...
public:
    ...
    virtual void zwp_virtual_keyboard_v1_keymap(Resource *resource,
                                                uint32_t format,
                                                int32_t fd,
                                                uint32_t size) = 0;
    virtual void zwp_virtual_keyboard_v1_key(Resource *resource,
                                             uint32_t time,
                                             uint32_t key,
                                             uint32_t state) = 0;
    virtual void zwp_virtual_keyboard_v1_modifiers(Resource *resource,
